...
Write-Host "Copy and past the following curl commands to validate the application."
Write-Host "curl -s https://api.ingress.${DomainName}/healthz" -ForegroundColor Green
