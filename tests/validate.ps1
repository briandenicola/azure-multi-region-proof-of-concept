...
.EXAMPLE
./validate.ps1 -DomainName bjd.demo -ResoureGroupName quetzal-8233_westus3_rg
...
Write-Host "...."
Write-Host "Running abritary commands with options is not supported by `'az containerapp exec`'."
